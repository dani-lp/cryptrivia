...
con números de coma flotante, que pueden tener errores de redondeo.

Las coordenadas las vamos a recibir en forma de un conjunto de números enteros separados
por comas; las coordenadas en sí estarán separadas por dos puntos. Este formato debemos
respetarlo para que el algoritmo funcione correctamente.
